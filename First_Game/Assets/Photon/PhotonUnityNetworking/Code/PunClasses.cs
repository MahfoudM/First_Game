...
namespace Photon.Pun
{
    ...
    ///
    /// This class implements all callback interfaces and extends <see cref="Photon.Pun.NetworkBehaviour"/>.
    /// </remarks>
    /// \ingroup callbacks
    // the documentation for the interface methods becomes inherited when Doxygen builds it.
    public class MonoBehaviourPunCallbacks : NetworkBehaviour, IConnectionCallbacks , IMatchmakingCallbacks , IInRoomCallbacks, ILobbyCallbacks, IWebRpcCallback, IErrorInfoCallback
    {
